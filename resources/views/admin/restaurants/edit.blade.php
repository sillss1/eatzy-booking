    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('admin.restaurants.update', $restaurant->id) }}">
            ...
            <div>
                ...
                <input type="number" name="capacity" min="1" value="{{ old('capacity', $restaurant->capacity) }}" required>
            </div>

            <div>
                <label>Description</label>
                <textarea name="description" required>{{ old('description', $restaurant->description) }}</textarea>
            </div>
